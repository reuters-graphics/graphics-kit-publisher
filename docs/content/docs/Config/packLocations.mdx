...
<FileTree>
  - dist - embeds - en \{locale}- page \{slug}- index.html - map \{slug}-
  index.html - de \{locale}- map \{slug}- index.html
</FileTree>
...
<FileTree>
  - media-files - en \{locale}- map \{slug}- map.eps EPS edition - map.jpg JPG
  edition - de \{locale}- map \{slug}- map.jpg JPG edition - map.pdf PDF edition
</FileTree>
