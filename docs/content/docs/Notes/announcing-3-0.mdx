...
On the near horizon is the possibility of unifying all our rigs, kit and AI embeds, into one graphics rig so you can always start the same way whether you're publishing pages or embeds, or even if you change your mind halfway through a project.

The flexibility added to the publisher in 3.0 is the foundation for that project.
