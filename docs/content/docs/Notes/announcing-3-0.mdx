...
That work was aimed at a few important targets:
...
The flexibility added in 3.0 is specifically designed to extend the publisher's reach beyond the graphics kit to other rigs, like those responsible for AI embeds and SREPs.
...
On the far horizon is the possibility of unifying all our rigs into the one graphics kit so you can always start the same way whether you're publishing pages or embeds, or even if you change your mind halfway through a project.
